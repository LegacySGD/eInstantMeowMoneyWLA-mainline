...
public class MeowMoneyWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MeowMoneyWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MeowMoneyWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MeowMoneyWLAIW/InitOutcome.xml").getDocumentElement();
